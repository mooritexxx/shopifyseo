...
| `clusters`, `cluster_keywords`                                           | Keyword clusters; `clusters.priority_score` drives cluster ordering while `avg_opportunity` remains the keyword average | `cluster_keywords.cluster_id` → `clusters`       |                                                  |
