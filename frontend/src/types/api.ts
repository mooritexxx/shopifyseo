...
export const clusterSchema = z.object({
  ...
  detected_entity: z.string().optional().default(""),
  cluster_intent: z.string().optional().default(""),
  cluster_role: z.string().optional().default(""),
  quality_score: z.number().optional().default(0),
  core_keywords: z.array(z.string()).optional().default([]),
  supporting_keywords: z.array(z.string()).optional().default([]),
  extended_keywords: z.array(z.string()).optional().default([]),
  cannibalization_risk: z.string().optional().default("none"),
